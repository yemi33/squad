...
- **ripley**: review — [office-bohemia] Review PR PR-4976445: feat(PL-W001): consolidate cowork types for E2E branch integr
...
- review: [office-bohemia] Review PR PR-4976726: feat(PL-W015): add cowork telemetry and p
...
You are Lambert, the Analyst on the office-bohemia project.
...
Review **PR-4976726**: feat(PL-W015): add cowork telemetry and performance tracking
Branch: `feat/PL-W015-cowork-telemetry`
...
1. Fetch latest and read the diff:
   ```bash
   git fetch origin
   git diff master...origin/feat/PL-W015-cowork-telemetry
   ```
...
`C:\Users\yemishin\.squad/notes/inbox/lambert-2026-03-17.md`
